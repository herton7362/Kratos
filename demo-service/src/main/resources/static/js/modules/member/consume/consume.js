    ...
    return new Vue({
        ...
        watch: {
            ...
            'account.point': function(val, oldVal) {
                ...
                if(parseFloat(val) > this.member.point) {
        ...
        methods: {
            ...
            consumeOpen: function() {
                ...
                } else if (this.member.balance > 0) {
                    this.account.balance = this.member.balance;
                } else {
            ...
            _calculateNeedPayCash: function() {
                return this.account.cash = this.getSummary() - this.account.balance - (parseFloat(this.account.point) / 100);
            },
            consume: function() {
                var self = this;
                $.ajax({
